...
import { Search, Bell, Bookmark, User, ChevronDown } from 'lucide-react';
import './Navbar.scss';
                ...
                <div className="navbar-left">
                    ...
                    <ul className="nav-links">
                        ...
                        <li className="dropdown-item">
                            ...
                            >
                                Categories
                                <ChevronDown size={16} className={categoriesOpen ? 'rotated' : ''} />
                            </button>
                            {categoriesOpen && (
                        ...
                        <li><Link to="/coming-soon/manga">Manga</Link></li>
                        <li><Link to="/coming-soon/games">Games</Link></li>
                        <li><Link to="/coming-soon/shop">Shop</Link></li>
                        <li><Link to="#">News</Link></li>
                    </ul>
                </div>

                <div className="navbar-right">
                    <div className="icon-btn" onClick={onSearchClick}><Search size={20} /></div>
                    <Link to="/watchlist" className="icon-btn"><Bookmark size={20} /></Link>
